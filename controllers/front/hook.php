...
class MyParcelBEHookModuleFrontController extends FrontControllerCore
{
    /**
    ...
    {
        if (! ModuleCore::isEnabled(MyParcelBE::MODULE_NAME)) {
    ...
    private function validateHash(): bool
    {
        ...
        if (! $hash || $hash !== ConfigurationCore::get(Constant::WEBHOOK_HASH_CONFIGURATION_NAME)) {
