...
use TranslateCore as Translate;
...
class OrderLabel extends ObjectModel
{
     ...
     * @param  int $shipmentId
     *
     * @return \Gett\MyparcelBE\Entity\OrderLabel
     */
    ...
    /**
     * @param  \Gett\MyparcelBE\Entity\OrderLabel $orderLabel
     *
     * @return array|null
